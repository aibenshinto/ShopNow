...
from .views import  ProductAPIView, AttributeAPIView, AttributeValueAPIView, ProductVariantAPIView, ProductVariantAttributeAPIView,ProductVariantAttributeCreateAPIView, product_variants_list, ProductVariantAttributeSearchAPIView,ProductVariantAttributeListAPIView
...
urlpatterns = [
    ...
    path('product-variant-attributes/', ProductVariantAttributeListAPIView.as_view(), name='product-variant-attribute-list'),
